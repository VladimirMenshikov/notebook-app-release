        ...
        children: const [
          ...
          _HelpSection(
            ...
            items: [
              ...
              'У подзадачи иконка карандаша открывает редактирование её '
                  'названия.',
              'Вкладки-фильтры сверху: «Все», «Активные», «Выполненные» — '
                  'при открытии раздела активна вкладка «Активные».',
            ],
          ),
          _HelpSection(
            ...
            items: [
              ...
              'Фильтр сверху разделяет вопросы «Без ответа» и «С ответом» — '
                  'при открытии раздела активен фильтр «Без ответа».',
            ],
          ),
          _HelpSection(
            ...
            title: 'Группы',
            items: [
              'Раздел «Мои группы» — на вкладке «Профиль». Там можно создать '
                  'группу, посмотреть её состав и свои приглашения.',
              'Создатель группы — администратор. Он приглашает участников по '
                  'email: если адрес уже зарегистрирован — приглашение придёт в '
                  '«Мои приглашения», его нужно принять; если нет — на почту '
                  'придёт ссылка, и при регистрации под этим адресом человек '
                  'сразу попадёт в группу.',
              'Переключатель «Личное / Группа» вверху разделов задаёт контекст: '
                  'в контексте группы видны её общие записи. Признак '
                  '«общее/личное» выбирается при создании записи.',
              'Администратор может забанить участника на срок (1/7/30 дней, '
                  'произвольная дата или бессрочно) или исключить из группы. '
                  'Забаненный не видит контент группы, пока бан не снят.',
              'Выйти из любой группы можно в разделе «Мои группы».',
            ],
          ),
          _HelpSection(
            icon: Icons.sync,
          ...
          _HelpSection(
            ...
            items: [
              ...
              '«Мои группы» — создание групп и управление участниками.',
